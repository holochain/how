        ...
        path: "soc_proto.process.define",
          ...
          content: [
            ...
            },
            {
              ...
              content: "{description of threshold for state to move to refinement}",
            },
            {
              name: "context",
              source: "soc_proto.process.define.declaration",
        ...
        path: "soc_proto.process.refine",
          ...
          content: [
            ...
            },
            {
              ...
              sectionType: SectionType.Requirement,
              contentType: "text/plain:long",
              content: "{description of threshold for state to move to alignment}",
            },
          ],
          editors: [progenitor],
          meta: {}
        ...
        path: "soc_proto.process.align",
          ...
          content: [
            ...
            },
            {
              ...
              sectionType: SectionType.Requirement,
              contentType: "text/plain:long",
              content: "{description of threshold for state to move to alive}",
            },
          ],
          editors: [progenitor],
          meta: {}
